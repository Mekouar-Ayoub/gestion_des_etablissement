            ...
            <div className="w-full flex flex-col h-screen">
                <header className="w-full items-center bg-[#3d68ff] py-2 px-6 hidden sm:flex">
                    ...
                    <div className="relative w-1/2 flex justify-end">
                        <button onClick={() => setIsslidOpen(!isSlidOpen)} className="realtive z-10 w-12 h-12 rounded-full  border-4 border-gray-400 hover:border-gray-300 focus:border-gray-300 focus:outline-none">
