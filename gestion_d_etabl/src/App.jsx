...
function App() {
  ...
  const lateralAdmin = () => {
    return (
      <>
        <header className="w-full items-center bg-[#3d68ff] py-2 px-6 hidden sm:flex overflow-disable ">
          ...
          <div className="relative w-1/2 flex justify-end">
            ...
            {isSlidOpen && (
              <div className="absolute w-32 z-[1] bg-white rounded-lg shadow-lg py-2 mt-16">
                <button
    ...
    <>
      ...
      <span className="overflow">
        ...
        !location.pathname.endsWith("login") ? (
          ...
          <>
            <>
              <span className="bg-blue-symphony">
