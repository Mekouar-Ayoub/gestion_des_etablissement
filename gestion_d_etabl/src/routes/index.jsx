  ...
  return (
    <Routes>
      <Route element={<ProtectedRoute user={"admin"} />}>
        ...
        <Route
          path="/admin/families/find/:familyId"
          element={<FamilyDetails isModify={false} />}
        />
        <Route
          path="/admin/families/find/:familyId/modify"
          element={<FamilyDetails isModify={true} />}
        />
        <Route
          path="/admin/families/:familyId/eleve/add"
          element={<AddMemberToFamily />}
        />
        ...
        <Route
          path="/admin/publications/addpublication"
          element={<AjouterPublication />}
        />
        <Route
          path="/admin/publications/:publicationId/modify"
          element={<ModifyPublication />}
        />
        <Route path="/admin/eleves/" element={<ShowAllmember />} />
        <Route
          path="/admin/eleves/:eleveId/modify"
          element={<UpdateMember isModifying={true} />}
        />
        <Route
          path="/admin/eleves/:eleveId"
          element={<UpdateMember isModifying={false} />}
        />
      ...
      <Route element={<ProtectedRoute user={"prof"} />}>
        ...
        <Route
          path="/prof/profil"
          element={<ProfProfile isModifying={false}></ProfProfile>}
        />
        <Route
          path="/prof/profil/modify"
          element={<ProfProfile isModifying={true}></ProfProfile>}
        />
      </Route>
      ...
      <Route element={<ProtectedRoute user={"eleve"} />}>
        <Route
          path="/eleve/cours/"
          element={<AfecherLesCours user="admin" />}
        />
        <Route path="/eleve/dashboard" element={<EleveDashboard />} />
        <Route
          path="/eleve/family/find/:famille_Id"
          element={<FamilyDetails />}
        />
        <Route
          path="/eleve/profil"
          element={<EleveProfile isModifying={false}></EleveProfile>}
        />
        <Route
          path="/eleve/profil/modify"
          element={<EleveProfile isModifying={true}></EleveProfile>}
        />
