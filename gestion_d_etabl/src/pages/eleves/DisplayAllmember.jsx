                        ...
                        <table className="min-w-full bg-white">
                            <thead className="bg-[#3788d8] text-white">
                                <tr>
                                    ...
                                    <th className="text-left py-3 px-4 uppercase font-semibold text-sm">Solde</th>
                            ...
                            <tbody className="text-gray-700">
                                {
                                    data.map((item) => (
                                        <tr key={item.id}>
                                            ...
                                            <td className="text-left py-3 px-4"><p className="hover:text-blue-500" >{item.tel}</p></td>
                                            <td className="text-left py-3 px-4"><p className="hover:text-blue-500" >{item.email}</p></td>
                                            <td className="text-left py-3 px-4"><p className="hover:text-blue-500" >{item.famille.nom}</p></td>
                                            <td className="text-left py-3 px-4"><p className="hover:text-blue-500" >{item.etudient && item.solde}</p></td>
                                            <td className="text-left py-3 px-4 flex">
                                                ...
                                                {isPaying && <>
                                                    ...
                                                    <div className="ml-[1%]">
                                                        ...
                                                        <br />
                                                        <select onChange={(e) => setTypePaiement(e.target.value)}>
