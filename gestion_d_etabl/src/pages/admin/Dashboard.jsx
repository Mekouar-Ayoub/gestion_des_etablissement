...
function Dashoard() {
    ...
    axios.get(process.env.REACT_APP_API_URL+'/profs/solde')
    .then(response => {
                
        setHistoryProfs(response.data.data);
    ...
    return (<>
            <div className="w-full flex-col h-screen overflow-y-hidden">
                                    ...
                                    {historyEcole && <tbody className="text-gray-700">
                                        {
                                            historyEcole.map((item) => (
                                                <tr key={item.id}>
                                                    ...
                                                    <td className=" text-left py-3 px-4">{item.cour && item.cour}</td>
                ...
                <table className="min-w-full bg-white">
                                    ...
                                    {historyEleves && <tbody className="text-gray-700">
                                        {
