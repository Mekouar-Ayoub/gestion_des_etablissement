                    ...
                    <div className="w-full mt-12">
                        {isModifyingEtat ? <>
                            <div>
                                ...
                                <select value={cour.titre} onChange={(e)=> {
                                    let newCour = cour
                                   ...
                                   </select> du <input readOnly value={cour.debut_de_coure} className="bg-stone-400" type='text' /> au <input readOnly className="bg-stone-400" value={cour.fin_de_coure} type='text' /> par le Professeur 
                                   <select onChange={(e)=> {
                                    let newCour = cour
                                    ...
                                    {profs.map(value => {
                                        return <option key={value.id} value={value.id}>{value.nom + ' ' + value.prenom}</option>
                                    })}
                                </select>
                            </div>
                            <div>
                            ...
                            <button className="bg-green-400 p-3" onClick={() => {
                                //TODO SAVE
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <button
                                            ...
                                            className="bg-green-400 p-3 hover:">Modifier</button>
                            ...
                            <div>
                                ...
                                </div><p className="text-xl pb-3 flex items-center">
                                    <i className="fas fa-list mr-3"></i>Tout les élèves qui ne sont pas dans le cours
                                </p><div className="bg-white overflow-auto">
